...
A simple proxy that injects the [sans bullshit sans] font on a web page. HTTP-only. Inspired by [Geocities-izer](http://www.wonder-tonic.com/geocitiesizer/).

##Usage
http://lmsbstfy.herokuapp.com/
---
...
get the app created:
    ...
    $ heroku apps:create lmsbstfy
    Creating lmsbstfy... done, stack is cedar
    http://lmsbstfy.herokuapp.com/ | git@heroku.com:lmsbstfy.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://lmsbstfy.herokuapp.com deployed to Heroku

    To git@heroku.com:lmsbstfy.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://lmsbstfy.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@lmsbstfy.herokuapp.com/repl
